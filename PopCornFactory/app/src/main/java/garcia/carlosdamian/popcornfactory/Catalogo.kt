...
class Catalogo : AppCompatActivity() {
    ...
    fun cargarPeliculas(series: ArrayList<Pelicula>, peliculas: ArrayList<Pelicula>) {
        ...
        series.add(
            Pelicula(
                "Dr. House", R.drawable.drhouse, R.drawable.drwhoheader, sinopsis = "The series follows the life of anti-social, pain killer addict, witty and arrogant medical doctor Gregory" +
        ...
        series.add(
            Pelicula(
                "Smallville", R.drawable.smallville, R.drawable.smallvilleheader, sinopsis = "The numerous miraculous rescues by the local wonder boy Clark have aroused suspicions amongst" +
        ...
        series.add(
            Pelicula(
                "Dr. Who", R.drawable.drwho, R.drawable.drwhoheader, sinopsis = "Traveling across time and space, the immortal time-lord known as &#39;The Doctor&#39; travels across the" +
        ...
        series.add(
            Pelicula(
                "Bones", R.drawable.bones, R.drawable.bonesheader, sinopsis = "Dr. Temperance Brennan is a brilliant, but lonely, anthropologist whom is approached by an" +
        ...
        series.add(
            Pelicula(
                "Suits", R.drawable.suits, R.drawable.suitsheader, sinopsis = "While running from a drug deal gone bad, brilliant young college dropout Mike Ross slips into a job" +
        ...
        series.add(
            Pelicula(
                "Friends", R.drawable.friends, R.drawable.friendsheader, sinopsis = "Rachel Green, Ross Geller, Monica Geller, Joey Tribbiani, Chandler Bing and Phoebe Buffay are" +
        ...
        peliculas.add(
            Pelicula(
                "Big Hero", R.drawable.bighero6, R.drawable.headerbighero6, sinopsis = "When a devastating event befalls the city of San Fransokyo and catapults Hiro into the" +
        ...
        peliculas.add(
            Pelicula(
                "1917", R.drawable.milnovecientos, R.drawable.milnovecientosheader, sinopsis = "British trenches somewhere in France. World war has been going on for the third year," +
        ...
        peliculas.add(
            Pelicula(
                "Leap Year", R.drawable.leapyear, R.drawable.leapyearheader, sinopsis = "A woman who has an elaborate scheme to propose to her boyfriend on Leap Day, an Irish" +
        ...
        peliculas.add(
            Pelicula(
                "Men in Black", R.drawable.mib, R.drawable.mibheader, sinopsis = "Based off of the comic book. Unbeknownst to other people, there is a private agency code" +
        ...
        peliculas.add(
            Pelicula(
                "Toy Story", R.drawable.toystory, R.drawable.toystoryheader, sinopsis = "Toy Story is about the &#39;secret life of toys&#39; when people are not around. When Buzz" +
        ...
        peliculas.add(
            Pelicula(
                "Inception", R.drawable.inception, R.drawable.inceptionheader, sinopsis = "Dom Cobb is a skilled thief, the absolute best in the dangerous art of extraction, stealing" +
